...
namespace JUTPS.JUInputSystem
{
    ...
    public class JUPlayerCharacterInputAsset : ScriptableObject
    {
        ...
        public class MovementActions
        {
            ...
            /// <summary>
            /// The action that contains the inputs to player punch on mobile.
            /// </summary>
            [Header("Mobile Punch Action")]
            public InputAction MobilePunchAction;

            /// <summary>
            /// The action that contains the buttons to player attack/shot on mobile.
            /// </summary>
            [Header("Mobile Shot Action")]
            public InputAction MobileShotAction;
            ...
            /// <summary>
            /// The action that contains the keys/buttons to player attack/shot.
            /// </summary>
            [Header("Shot Action")]
            ...
            public MovementActions()
            {
                ...
                MobilePunchAction = new InputAction("Mobile Punch");
                MobilePunchAction.AddBinding("<Gamepad>/buttonNorth");

                MobileShotAction = new InputAction("Mobile Shot");
                MobileShotAction.AddBinding("<Gamepad>/rightTrigger");
        ...
        /// <summary>
        /// The result direction to move based on the <see cref="MoveAction"/> or <see cref="MobileMoveAction"/> if on mobile.
        /// </summary>
        ...
        /// <summary>
        /// The axis with turn view direction, like mouse delta or joystick direction using <see cref="LookAction"/> or <see cref="MobileLookAction"/> if on mobile.
        /// </summary>
        ...
        /// <summary>
        ///  Return true if the <see cref="JumpAction"/> was pressend by first time.
        /// </summary>
        ...
        /// <summary>
        /// Return true if is pressing <see cref="RunAction"/>.
        /// </summary>
        ...
        /// <summary>
        /// Return true if the <see cref="RunAction"/> was pressend by first time.
        /// </summary>
        ...
        /// <summary>
        /// Return true if the <see cref="RunAction"/> was dropped.
        /// </summary>
        ...
        /// <summary>
        /// Return true if is pressing <see cref="ShotAction"/> or <see cref="MobileShotAction"/> if on mobile.
        /// </summary>
        public bool IsShotPressed
        {
            get
            {
                if (JUGameManager.IsMobileControls)
                {
                    ...
                    return Movement.MobileShotAction.inProgress;
                }
        ...
        /// <summary>
        /// Return true if the <see cref="ShotAction"/> or <see cref="MobileShotAction"/> (if on mobiel) was pressend by first time.
        /// </summary>
        public bool IsShotTriggered
        {
            get
            {
                if (JUGameManager.IsMobileControls)
                {
                    ...
                    return Movement.MobileShotAction.WasPressedThisFrame();
                }
        ...
        /// <summary>
        /// Return true if is pressing <see cref="PunchAction"/>.
        /// </summary>
        public bool IsPunchPressed
        {
            get
            {
                if (JUGameManager.IsMobileControls)
                {
                    ...
                    return Movement.MobilePunchAction.inProgress;
                }
        ...
        /// <summary>
        /// Return true if the <see cref="PunchAction"/> or <see cref="MobilePunchAction"/> (if on mobile) was pressend by first time.
        /// </summary>
        public bool IsPunchTriggered
        {
            get
            {
                if (JUGameManager.IsMobileControls)
                {
                    ...
                    return Movement.MobilePunchAction.WasPressedThisFrame();
                }
        ...
        /// <summary>
        /// Return true if the <see cref="AimAction"/> was pressend by first time.
        /// </summary>
        ...
        /// <summary>
        /// Return true if is pressing <see cref="AimAction"/>.
        /// </summary>
        ...
        public void SetActiveInputs(bool active)
        {
            switch (active)
            {
                case true:
                    ...
                    Movement.MobilePunchAction.Enable();
                    Movement.MobileShotAction.Enable();
                ...
                case false:
                    ...
                    Movement.MobilePunchAction.Disable();
                    Movement.MobileShotAction.Disable();
