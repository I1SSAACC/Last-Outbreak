...
namespace JU.CharacterSystem.AI
{
    ...
    public class FieldOfView
    {
        ...
        /// <summary>
        /// The AI head. If not have, the field of view will use the AI bounds center as pivot. 
        /// </summary>
        [Space]
        ...
        /// <summary>
        /// Return the field of view position, <see cref="Pivot"/> if is assigned. If not, return the AI bounds center.
        /// </summary>
        public Vector3 Center
        {
            get => Pivot ? Pivot.position : _ai.Center;
        }

        /// <summary>
        /// The field of view forward direction. Return the <see cref="Pivot"/> forward if assigned. If not, return the AI transform direction.
        /// </summary>
        public Vector3 Forward
        {
            ...
            {
                if (Pivot)
                    return Vector3.ProjectOnPlane(Pivot.forward, Vector3.up);
